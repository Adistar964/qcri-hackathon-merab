  ...
  return (
    <div className="mb-2">
      <button
        ...
        className="flex w-full items-center gap-2 border-2 border-line bg-surface px-3 py-2 text-[11px] font-bold uppercase tracking-[0.2em] text-muted-foreground transition hover:border-accent hover:text-accent"
      >
        ...
        {busy ? (
          <span className="flex items-center gap-2 text-accent">
            ...
            <span className="flex gap-1">
              <span className="typing-dot h-1.5 w-1.5 bg-accent" />
              <span className="typing-dot h-1.5 w-1.5 bg-accent" />
              <span className="typing-dot h-1.5 w-1.5 bg-accent" />
            </span>
          </span>
        ...
        <span className="ml-auto text-[10px] tracking-normal text-muted">{open ? "Hide" : "Show"}</span>
      </button>
      {open && (
        <div className="mt-2">
